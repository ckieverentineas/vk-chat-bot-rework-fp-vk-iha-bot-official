...
В остальных случаях в консоле cmd или другом терминале открыть корень проекта и использовать следующие команды:
...
В остальных случаях в консоле cmd или другом терминале открыть корень проекта и применить следующие команды:
...
💡 Скорость сохранения 6-7 строк в секунду (если они являются еще неизвестными) рекомендуется не класть файл больше, чем 10-15 МБ, лучше разделить на файлы по 10 МБ и запихать сколько угодно <br />
