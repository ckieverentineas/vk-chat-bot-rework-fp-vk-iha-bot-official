...
🚀 Добавлена возможность подключения бота к группе вконтакте <br />
🚀 Группа отвечает на сообщения со стены от трех сообщений <br />
🚀 NEW Реализовано запоминание последнего сказанного слова пользователями; <br />
🚀 NEW Оптимизирован алгоритм поиска ответов; <br />
🚀 NEW Добавлен новый FastBoot режим для быстрого поиска ответов. <br />
____
